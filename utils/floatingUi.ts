...
import { type App, type DirectiveBinding, type Ref, createApp, h } from 'vue'
...
export function resolveBootstrapPlacement(placement: Placement): string {
...
export function resolveActiveStatus(values: DirectiveBinding['value']): boolean {
  return typeof values !== 'object' || values.active !== false
}

export function resolveContent(values: DirectiveBinding['value'],
  el: HTMLElement): { title?: string; content?: string } {
...
export function resolveDirectiveProps(binding: DirectiveBinding, el: HTMLElement) {
  return {
    target: () => el,
...
export function bind(el: ElementWithPopper, binding: DirectiveBinding) {
...
export function unbind(el: ElementWithPopper) {
