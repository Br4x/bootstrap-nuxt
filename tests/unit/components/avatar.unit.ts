...
import Avatar from '@/components/B/Avatar'
...
describe('avatar', () => {
  ...
  it('should handle b-avatar-group size', async () => {
    ...
    // Should use AvatarGroup size prop
