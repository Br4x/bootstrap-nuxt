...
<Canvas of={TabsStory.BasicUsage} />
...
<Canvas of={TabsStory.CardsIntegration} />
...
<Canvas of={TabsStory.CardsIntegration1} />
...
<Canvas of={TabsStory.PillsVariant} />
...
<Canvas of={TabsStory.VerticalTabs2} />
...
<Canvas of={TabsStory.ActiveClasses} />
...
<Canvas of={TabsStory.AddTabsWithoutContent} />
...
<Canvas of={TabsStory.AddCustomContentToTabTitle} />
...
<Canvas of={TabsStory.ApplyCustomClassesToTheGeneratedNavTabsOrPills} />
...
<Canvas of={TabsStory.ExternalControlsUsingVModel} />

### Dynamic tabs + tabs-end slot

<Canvas of={TabsStory.DynamicTabsTabsEndSlot} />
