...
import * as TooltipStory from './Tooltip.stories';

<Meta of={TooltipStory} />
...
<Canvas of={TooltipStory.Tooltip} />
...
<Canvas of={TooltipStory.CaveatsWithFocusTriggerOnButtonElements} />
...
<Canvas of={TooltipStory.DisabledElements} />

## `<b-tooltip>` component usage

<Canvas of={TooltipStory.BTooltipComponentUsage} />
...
<Canvas of={TooltipStory.NoninteractiveTooltips} />
...
<Canvas of={TooltipStory.VariantsAndCustomClass} />
...
<Canvas of={TooltipStory.VariantsAndCustomClass1} />
...
<Canvas of={TooltipStory.ProgrammaticallyShowAndHideTooltip} />

To make the tooltip shown on initial render, simply add the `show` prop on `<b-tooltip>`:

<Canvas of={TooltipStory.ProgrammaticallyShowAndHideTooltip1} />

Programmatic control can also be affected by submitting `'open'` and `'close'` events to the tooltip
by reference.

<Canvas of={TooltipStory.ProgrammaticallyShowAndHideTooltip2} />
...
<Canvas of={TooltipStory.ProgrammaticallyDisablingTooltip} />
...
<Canvas of={TooltipStory.VBTooltipDirectiveUsage} />
