...
import * as NavbarStory from './Navbar.stories';
...
<Canvas of={NavbarStory.BNavbarBrand} />

<Canvas of={NavbarStory.BNavbarBrand1} />
...
<Canvas of={NavbarStory.BNavbarBrand2} />

<Canvas of={NavbarStory.BNavbarBrand3} />
...
<Canvas of={NavbarStory.BNavText} />
...
<Canvas of={NavbarStory.BNavItemDropdown} />

### `<b-nav-form>`

Use `<b-nav-form>` to place inline form controls into your navbar

<Canvas of={NavbarStory.BNavForm} />

Input Groups work as well:

<Canvas of={NavbarStory.BNavForm1} />
...
<Canvas of={NavbarStory.CustomNavbarToggle} />
