...
import * as FormInputStory from './FormInput.stories';

<Meta of={FormInputStory} />
...
<Canvas of={FormInputStory.FormInput} />
...
<Canvas of={FormInputStory.InputType} />
...
<Canvas of={FormInputStory.RangeTypeInput} />
...
<Canvas of={FormInputStory.RangeTypeInput1} />
...
<Canvas of={FormInputStory.ControlSizing} />
...
<Canvas of={FormInputStory.ContextualStates} />

**Live Example**

<Canvas of={FormInputStory.ContextualStates1} />
...
<Canvas of={FormInputStory.FormatterSupport} />
...
<Canvas of={FormInputStory.DatalistSupport} />
...
<Canvas of={FormInputStory.DebounceSupport} />
...
<Canvas of={FormInputStory.UsingHtml5InputAsAnAlternative} />
