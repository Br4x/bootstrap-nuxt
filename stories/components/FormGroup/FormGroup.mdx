...
import * as FormGroupStory from './FormGroup.stories';

<Meta of={FormGroupStory} />
...
<Canvas of={FormGroupStory.FormGroup} />
...
<Canvas of={FormGroupStory.HorizontalLayout} />
...
<Canvas of={FormGroupStory.LabelSize} />
...
<Canvas of={FormGroupStory.NestedFormGroups} />
