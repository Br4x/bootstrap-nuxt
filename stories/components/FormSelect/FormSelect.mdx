...
import * as FormSelectStory from './FormSelect.stories';

<Meta of={FormSelectStory} />
...
<Canvas of={FormSelectStory.FormSelect} />

You can even define option groups with the `options` prop:

<Canvas of={FormSelectStory.FormSelect1} />

Or manually provide your options and option groups:

<Canvas of={FormSelectStory.FormSelect2} />
...
<Canvas of={FormSelectStory.FormSelect3} />
...
<p class="alert alert-danger">
  ...
  <a class="alert-link" href="https://en.wikipedia.org/wiki/HTML_sanitization">sanitize</a> the user supplied string.
</p>
...
<Canvas of={FormSelectStory.ChangingTheOptionFieldNames} />
...
<Canvas of={FormSelectStory.OptionNotes} />
...
<Canvas of={FormSelectStory.ValueInSingleMode} />
...
<Canvas of={FormSelectStory.SelectSizingDisplayedRows} />
...
<Canvas of={FormSelectStory.ValueInMultipleMode} />
