...
import * as OverlayStory from './Overlay.stories';

<Meta of={OverlayStory} />
...
<Canvas of={OverlayStory.Overview} />
...
<Canvas of={OverlayStory.OverlayBackdropColor} />
...
<Canvas of={OverlayStory.DefaultSpinnerStyling} />
...
<Canvas of={OverlayStory.OverlayCornerRounding} />
...
<Canvas of={OverlayStory.CustomOverlayContent} />
...
<Canvas of={OverlayStory.OverlayContentCentering} />
...
<Canvas of={OverlayStory.NonWrappingMode} />
...
<Canvas of={OverlayStory.NonWrappingMode1} />
...
<Canvas of={OverlayStory.LoadingButton} />

### Busy state input group

In this example, we obscure the input and button:

<Canvas of={OverlayStory.BusyStateInputGroup} />
...
<Canvas of={OverlayStory.FormConfirmationPromptAndUploadStatus} />
