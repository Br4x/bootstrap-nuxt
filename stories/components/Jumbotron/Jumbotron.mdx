...
import * as JumbotronStory from './Jumbotron.stories';

<Meta of={JumbotronStory} />
...
<Canvas of={JumbotronStory.Jumbotron} />

**Usage with slots:**

<Canvas of={JumbotronStory.Jumbotron1} />
...
<Canvas of={JumbotronStory.Variants} />
