...
import * as CalendarStory from './Calendar.stories';
...
<Canvas of={CalendarStory.Overview} />
...
<Canvas of={CalendarStory.DisabledAndReadonlyStates} />
...
<Canvas of={CalendarStory.MinimumAndMaximumDates} />
...
<Canvas of={CalendarStory.DisablingDates} />
...
<Canvas of={CalendarStory.Variants} />
...
<Canvas of={CalendarStory.DateStringFormat} />
...
<Canvas of={CalendarStory.BorderAndPadding} />
...
<Canvas of={CalendarStory.DefaultSlot} />
...
<Canvas of={CalendarStory.AddingCssClassesToSpecificDates} />
...
<Canvas of={CalendarStory.Internationalization} />
