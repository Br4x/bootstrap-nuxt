...
import * as CarouselStory from './Carousel.stories';

<Meta of={CarouselStory} />
...
<Canvas of={CarouselStory.Carousel} />
...
<Canvas of={CarouselStory.CrossfadeAnimation} />

### Disable animation

Set the `<b-carousel>` `no-animation` prop to `true` to disable slide animation.

<Canvas of={CarouselStory.DisableAnimation} />
...
<Canvas of={CarouselStory.ProgrammaticSlideControl} />
