...
export default defineComponent({
  props: {
    ...
    required: { type: [Boolean, String] as PropType<boolean>, default: false },
  ...
  setup(props, { emit }) {
    ...
    const computedMultiplier = computed(() => 10 ** (computedPrecision.value || 0))
      ...
      const $spin = h(
        ...
        [
          h(
            ...
            // @ts-expect-error How can we narrow this type down
