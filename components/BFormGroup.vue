...
export default defineComponent({
  ...
  setup(props, { attrs }) {
    ...
    const computedAriaInvalid = computed(() => resolveAriaInvalid(attrs.ariaInvalid as unknown as AriaInvalid, props.state))
    ...
    const onLegendClick = (event: MouseEvent) => {
      ...
      if (LEGEND_INTERACTIVE_ELEMENTS.includes(tagName))
        return
